...
public class Strings {
     ...
     * 头像宽高
     */
    public final static int AVATAR_WH = 400;
    ...
    public final static String ARTICLE = "文章";
    public final static String PLANT = "植物";
    public final static String PRESS_EXIT_PROCEDURE_AGAIN = "再按一次退出程序";
    /* 植物分类 */
    public final static int PLANT_SORT = 1;
    /* 文章分类 */
    public final static int ARTICLE_SORT = 2;
    ...
    public final static String COLLECT_FAILURE = "收藏失败";
    public final static String CANCEL_COLLECT_SUCCESS = "取消收藏成功";
    public final static String CANCEL_COLLECT_FAILURE = "取消收藏失败";
    public final static String COLLECT = "收藏";
